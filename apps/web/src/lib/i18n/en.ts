const en = {
  ...
  pricing: {
    ...
    confirmFrom: "Current",
    confirmTo: "New plan",
    confirmCredits: "Additional credits",
    confirmProration: "The price difference will be prorated and charged immediately.",
    confirmCancel: "Cancel",
    confirmApply: "Confirm Change",
  ...
  subscription: {
    ...
    canceledNotice: "Your subscription has been canceled. You can continue using your current plan until {date}.",
